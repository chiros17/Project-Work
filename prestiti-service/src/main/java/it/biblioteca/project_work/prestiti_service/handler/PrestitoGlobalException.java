package it.biblioteca.project_work.prestiti_service.handler;
...
@ControllerAdvice
public class PrestitoGlobalException {
    ...
    @ExceptionHandler(PrestitoNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handlerBookNotFoundException( PrestitoNotFoundException e ){
        return new ResponseEntity<>(getRet("404", "il prestito richiesto non è presente sulla base dati" ), HttpStatus.NOT_FOUND);
    }
