...
public class BookGlobalException {
    ...
    public ResponseEntity<Map<String, Object>> handlerBookNotFoundException( BookNotFoundException e ){
        return new ResponseEntity<>(getRet("404", "il book richiesto non è presente sulla base dati" ), HttpStatus.NOT_FOUND);
    }
